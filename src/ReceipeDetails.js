...
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
 ...
 export function ReceipeDetails({  Receipes }) {
  ...
  const styles = receipe.rating > 4.4 ? {color : 'teal', fontWeight: 'bold'} : {color : 'crimson', fontWeight: 'bold'};
  return (
...
<iframe width="853" height="480" src="https://www.youtube.com/embed/Rh4EI4luKAQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
